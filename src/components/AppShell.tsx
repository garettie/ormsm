...
const AppShell: FC<AppShellProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-12">
      {/* Global header */}
      <header className="sticky top-4 z-50 mb-8 mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 transition-transform duration-300">
            ...
            <div className="flex bg-gray-100/80 rounded-xl p-1 gap-0.5">
              {modules.map((mod) => (
                <button
                  ...
                  className={cn(
                    "relative px-4 py-2 rounded-lg text-sm font-semibold transition-colors duration-300 whitespace-nowrap",
                ...
                >
                  ...
                  {mod.key === 'rcsa' && (
                    <div 
                      ...
                      className={cn(
                        "absolute -top-2 -right-1 px-1.5 py-0.5 rounded-full text-[8px] font-bold uppercase tracking-wider shadow-sm transition-colors duration-300 ring-1 cursor-pointer",
                        demoMode 
